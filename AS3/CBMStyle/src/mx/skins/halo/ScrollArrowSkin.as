...
/*  				drawRoundRect(
				 ...
				 */
				// fake line
				if(name == "upArrowUpSkin"){
					g.beginFill(trackColors[0])
...
/* 				if (!horizontal)
			...
			case "downArrowOverSkin":
			{
				...
				drawRoundRect(
					0, 0, w, h, 0,
					[ borderColors[0], borderColors[1] ], 1,
					horizontal ?
					horizontalGradientMatrix(0, 0, w, h) :
					verticalGradientMatrix(0, 0, w, h),
					GradientType.LINEAR, null, 
